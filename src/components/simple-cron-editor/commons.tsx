...
export const DAYS_OF_WEEK: CronField[] = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'].map((name, idx) => ({
  name,
  value: idx + 1
}));
export const DAYS_OF_MONTH: CronField[] = [{ name: 'firstDay', value: '1' }, { name: 'lastDay', value: 'L' }];
